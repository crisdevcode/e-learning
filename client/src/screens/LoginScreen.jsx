...
const LoginScreen = () => {
  ...
  useEffect(() => {
    if (userInfo) {
      ...
      toast({ description: 'Inicio de sesión correcto.', status: 'success', isClosable: true });
    }
          ...
          <Stack spacing="8">
            ...
            >
              <Stack spacing="6" as="form" onSubmit={formik.handleSubmit}>
                ...
                <Stack spacing="5">
                  <FormControl>
                    <TextField type="text" name="email" placeholder="tucorreo@gmail.com" label="Correo electrónico" />
