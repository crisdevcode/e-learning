    ...
    >
      {(formik) => (
        <VStack as="form">
          ...
          >
            <TextField name="address" placeholder="tu dirección" label="Dirección de envío" />
            <Flex>
              <Box flex="1" mr="10">
                <TextField name="postalCode" placeholder="tu código postal" label="Código Postal" type="number" />
              </Box>
              <Box flex="2">
                <TextField name="city" placeholder="tu ciudad" label="Ciudad" />
              </Box>
            </Flex>
            <TextField name="country" placeholder="tu país" label="País" />
          </FormControl>
